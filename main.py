...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # --- 大富翁主要卡片 (示範) ---
        self.cards = [
            Card(name="小港 Xiaogang", color="咖啡", price="$60", rent="$2", set_rent="$4",
                 house_rents=["$10","$30","$90","$160"], hotel_rent="$250",house_cost="$50",mortgage="$30",unmortgage = "$33"),
            Card(name="大寮 Daliao", color="咖啡", price="$60", rent="$4", set_rent="$8",
                 house_rents=["$20","$60","$180","$320"], hotel_rent="$450",house_cost="$50",mortgage="$30",unmortgage = "$33"),
            Card(name="左營高鐵站 ZY HSR", color="交通", price="$200"),
            Card(name="清水 Qingshui", color="淺藍", price="$100", rent="$6", set_rent="$12",
                 house_rents=["$30","$90","$270","$400"], hotel_rent="$550",house_cost="$50",mortgage="$50",unmortgage = "$55"),
            Card(name="台中遠雄 Farglory", color="淺藍", price="$100", rent="$6", set_rent="$12",
                 house_rents=["$30","$90","$270","$400"], hotel_rent="$550",house_cost="$50",mortgage="$50",unmortgage = "$55"),
            Card(name="烏日 Wuri", color="淺藍", price="$120", rent="$8", set_rent="$16",
                 house_rents=["$40","$100","$300","$450"], hotel_rent="$600",house_cost="$50",mortgage="$60",unmortgage = "$66"),
            Card(name="夢時代 Dream mall", color="粉", price="$140", rent="$10", set_rent="$20", 
                 house_rents=["$50","$150","$450","$625"], hotel_rent="$750",house_cost="$100",mortgage="$70",unmortgage = "$77"),
            Card(name="純文實業", color="公司", price="$150"),
            Card(name="鳳山 Fongshang", color="粉", price="$140", rent="$10", set_rent="$20", 
                 house_rents=["$50","$150","$450","$625"], hotel_rent="$750",house_cost="$100",mortgage="$70",unmortgage = "$77"),
            Card(name="海港 Harbor", color="粉", price="$160", rent="$12", set_rent="$24",
                 house_rents=["$60","$180","$500","$700"], hotel_rent="$900",house_cost="$100",mortgage="$80",unmortgage = "$88"),
            Card(name="桃園機場 TPE Airport", color="交通", price="$200"),
            Card(name="中央大學 NCU", color="橘", price="$180", rent="$14", set_rent="$28",
                 house_rents=["$70","$200","$550","$750"], hotel_rent="$950",house_cost="$100",mortgage="$90",unmortgage = "$99"),
            Card(name="白帥帥新光店 laundry", color="橘", price="$180", rent="$14", set_rent="$28",
                 house_rents=["$70","$200","$550","$750"], hotel_rent="$950",house_cost="$100",mortgage="$90",unmortgage = "$99"),
            Card(name="義大飯店 E-DA", color="橘", price="$200", rent="$16", set_rent="$32",
                 house_rents=["$80","$220","$600","$800"], hotel_rent="$1000",house_cost="$100",mortgage="$100",unmortgage = "$110"),
            Card(name="白帥帥興中店 laundry", color="紅", price="$220", rent="$18", set_rent="$36",
                 house_rents=["$90","$250","$700","$875"], hotel_rent="$1050",house_cost="$150",mortgage="$110",unmortgage = "$121"),
            Card(name="台灣大學 NTU", color="紅", price="$220", rent="$18", set_rent="$36",
                 house_rents=["$90","$250","$700","$875"], hotel_rent="$1050",house_cost="$150",mortgage="$110",unmortgage = "$121"),
            Card(name="北師大 TNU", color="紅", price="$240", rent="$20", set_rent="$40",
                 house_rents=["$100","$300","$750","$925"], hotel_rent="$1100",house_cost="$150",mortgage="$120",unmortgage = "$132"),
            Card(name="台北高鐵站 TPE HSR", color="交通", price="$200"),
            Card(name="海洋大學 NTOU", color="黃", price="$260", rent="$22", set_rent="$44",
                 house_rents=["$110","$330","$800","$975"], hotel_rent="$1150",house_cost="$150",mortgage="$130",unmortgage = "$143"),
            Card(name="薇閣中學 WEGO", color="黃", price="$260", rent="$22", set_rent="$44",
                 house_rents=["$110","$330","$800","$975"], hotel_rent="$1150",house_cost="$150",mortgage="$130",unmortgage = "$143"),
            Card(name="洪志淳皮膚科", color="公司", price="$150"),
            Card(name="天母 Tianmu", color="黃", price="$280", rent="$24", set_rent="$48",
                 house_rents=["$120","$360","$850","$1025"], hotel_rent="$1200",house_cost="$150",mortgage="$140",unmortgage = "$154"),
            Card(name="昭明國小 Zhaoming", color="綠", price="$300", rent="$26", set_rent="$52",
                 house_rents=["$130","$390","$900","$1100"], hotel_rent="$1275",house_cost="$200",mortgage="$150",unmortgage = "$165"),
            Card(name="信義國小 Xingyi", color="綠", price="$300", rent="$26", set_rent="$52",
                 house_rents=["$130","$390","$900","$1100"], hotel_rent="$1275",house_cost="$200",mortgage="$150",unmortgage = "$165"),
            Card(name="蒲園 Puyuan", color="綠", price="$320", rent="$28", set_rent="$56",
            ...
            Card(name="倫敦 London", color="藍", price="$400", rent="$50", set_rent="$100",
